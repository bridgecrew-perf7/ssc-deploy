...
class InvalidGitRepositoryUrlException extends Exception implements ExceptionInterface
{
    const MESSAGE = 'ERROR: The URL "%s" does not point to a readable remote the root of the git working repository.';
    const CODE = 128;
